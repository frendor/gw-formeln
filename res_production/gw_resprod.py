...
lut_function = lambda stufe, use_osc = True: res_function(stufe, speed=1, res_type="Lut" , use_osc=use_osc)
h2o_function = lambda stufe, use_osc = True: res_function(stufe, speed=1, res_type="H2O" , use_osc=use_osc)
h2_chem_function = lambda stufe, use_osc = True: res_function(stufe, speed=1, res_type="H2C" , use_osc=use_osc) 
...
h2_echem_function = lambda stufe, use_osc=True: np.round(h2_echem_base_func(stufe) + h2_echem_osc_func(stufe), decimals=6)
...
fe_6x_function = lambda stufe, use_osc=True: res_function(stufe, speed=6, res_type="Fe", use_osc=use_osc)
lut_6x_function = lambda stufe, use_osc=True: res_function(stufe, speed=6, res_type="Lut", use_osc=use_osc)
h2o_6x_function = lambda stufe, use_osc=True: res_function(stufe, speed=6, res_type="H2O", use_osc=use_osc)
h2_chem_6x_function = lambda stufe, use_osc=True: res_function(stufe, speed=1.2, res_type="H2C", use_osc=use_osc) 
#h2_chem_6x_function = lambda stufe, use_osc=True: np.round( 2.4 * (base_func(stufe) + linear_split_func(stufe)) + usc_osc * osc_func()
h2_chem_6x_function = lambda stufe, use_osc=True: res_function(stufe, speed=1, res_type="H2C_6x", use_osc=use_osc) 

h2_echem_6x_function = lambda stufe, use_osc=True: np.round( res_factor["H2EC"] * 6 * (base_func(stufe) + linear_split_func(stufe)) + use_osc * h2_echem_6x_osc_func(stufe) ,decimals=use_osc*6)
